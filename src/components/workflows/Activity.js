    ...
    <Card>
      ...
      >
        ...
        >
          ...
          >
            Initiated by Sara Weston on the behave of Payslip Employ on 04 June 2021
          </Typography>
          <Typography
            sx={{
              fontSize: { xs:16, sm:18 },
          ...
          >
            "Selected On Probation as on Option for Probation Completed but changed Probation End Date to 3/6"
          </Typography>
        </Grid>
      </Grid>
    </Card>
